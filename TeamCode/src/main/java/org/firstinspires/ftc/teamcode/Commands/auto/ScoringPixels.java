            ...
            public ScoringPixels(RobotControl robot, Side side) {
                super(
                        new ParallelCommandGroup(
                                new TrajectoryFollowerCommand(Trajectories.get("Driving from board to collect from stack"), robot.driveTrain),
                        ...
                        new IntakeSetStackPosition(robot.intake.lifter, Intake.LifterPosition.STANDBY),
                        new TrajectoryFollowerCommand(Trajectories.get("Driving to score from pixel stack"), robot.driveTrain),
