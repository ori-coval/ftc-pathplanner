...
//        turretMotor = hardwareMap.dcMotor.get(Configuration.TURRET_ENCODER);
        turretMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER); //resets encoder to 0
        turretMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER); //makes it use power from -1 to 1
    ...
    public double getAngle(){
        return turretMotor.getCurrentPosition()/TICKS_PER_REV * 360 * GEAR_RATIO;
    }
