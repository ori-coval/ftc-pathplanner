...
import org.firstinspires.ftc.teamcode.Commands.drivetrain.AutoDriveCommand;
 ...
 * It tests the field-centric mode of the {@link AutoDriveTrain}.
...
public class FieldCentricTest extends CommandOpMode {
    ...
    public void initialize() {
        ...
        drive = new AutoDriveTrain(new SampleMecanumDrive(hardwareMap), true);

        register(drive);
        drive.setDefaultCommand(new AutoDriveCommand(
