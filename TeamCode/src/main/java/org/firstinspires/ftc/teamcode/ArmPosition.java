...
public enum ArmPosition {
   ...
   close  far
    ...
    SCORE_FIRST_CYCLE_LOW_RED(12.34, Extender.Position.OPEN, 0, 0.45, 183, Cluster.scoring),
    SCORE_FIRST_CYCLE_LOW_BLUE(12.34, Extender.Position.OPEN, 0, 0.45, 183, Cluster.scoring),
