...
public enum ArmPosition {
   ...
   close  far
    ...
    SCORE_MID_FAR(27.346, Extender.Position.MID_WAY, 55, 0.35, 120, Cluster.scoring),
    ...
    SCORE_BOTTOM_FRONT_BLUE(10.48, Extender.Position.BOTTOM_FRONT, 0, 0.34, 183, Cluster.scoring),
    SCORE_FIRST_CYCLE_LOW_RED(12.34, Extender.Position.OPEN, 0, 0.47, 183, Cluster.scoring),
    SCORE_FIRST_CYCLE_LOW_BLUE(12.34, Extender.Position.OPEN, 0, 0.47, 183, Cluster.scoring),
    SCORE_BOTTOM_FRONT_LOWER(14, Extender.Position.BOTTOM_FRONT, 0, 0.3, 183, Cluster.scoring),
    ...
    SCORE_AUTO_BOTTOM_MID_RED(16, Extender.Position.FAR_CENTER_RED, 64, 0.35, 125, Cluster.scoring),
    SCORE_AUTO_BOTTOM_FAR_BLUE_CLOSE(19, Extender.Position.MID_WAY, 64, 0.33, 125, Cluster.scoring),
    SCORE_AUTO_BOTTOM_MID_BLUE(19, Extender.Position.MID_WAY, 64, 0.35, 125, Cluster.scoring),
    SCORE_AUTO_BOTTOM_FAR_RED_CLOSE(19, Extender.Position.MID_WAY, 64, 0.35, 110, Cluster.scoring),
    ...
    SCORE_BOTTOM_CLOSE_BLUE_CLOSE(12.34, Extender.Position.CLOSED, 50, 0.34, 120, Cluster.scoring),
    SCORE_BOTTOM_CLOSE_BLUE(12.34, Extender.Position.CLOSED, 56, 0.34, 110, Cluster.scoring),
    ...
    AUTONOMOUS_PURPLE_PIXEL_1(0, Extender.Position.AUTONOMOUS_PURPLE, 0, 0.20, 0, Cluster.intake),
