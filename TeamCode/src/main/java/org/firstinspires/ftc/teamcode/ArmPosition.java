...
public enum ArmPosition {
   ...
   close  far
    ...
    SCORE_FIRST_CYCLE_LOW_RED(12.34, Extender.Position.OPEN, 0, 0.4, 183, Cluster.scoring),
    SCORE_FIRST_CYCLE_LOW_BLUE(12.34, Extender.Position.OPEN, 0, 0.4, 183, Cluster.scoring),
    ...
    SCORE_AUTO_BOTTOM_FAR_RED_CLOSE(19, Extender.Position.MID_WAY, 64, 0.35, 120, Cluster.scoring),
