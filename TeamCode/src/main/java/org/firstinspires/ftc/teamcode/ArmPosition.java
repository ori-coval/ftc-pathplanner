...
public enum ArmPosition {
   ...
   close  far
    ...
    INTAKE(-0.2, Extender.Position.CLOSED, 0,0, 0, Cluster.intake),
    AUTO_INTAKE(-0.2, Extender.Position.CLOSED_INTAKE, 0,0.04, 0, Cluster.intake),
    ...
    THIRD_TEST_POSITION(10000/*infinite_height*/, Extender.Position.OPEN, 0, 0.7, 0.4, Cluster.scoring),
