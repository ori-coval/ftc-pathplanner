...
public enum ArmPosition {
   ...
   close  far
    ...
    SCORE_AUTO_BOTTOM_FAR_2(18.714 + 10, Extender.Position.OPEN, 74.72, 0.336, 1, Cluster.scoring),
    SCORE_AUTO_BOTTOM_FAR(18.714, Extender.Position.OPEN, 74.72, 0.336, 1, Cluster.scoring),
    SCORE_AUTO_BOTTOM_MID_2(17.59 + 10, Extender.Position.MID_WAY, 74, 0.336, 1, Cluster.scoring),
    SCORE_AUTO_BOTTOM_MID(17.59, Extender.Position.MID_WAY, 74, 0.336, 1, Cluster.scoring),
    SCORE_BOTTOM_CLOSE_2(12.34 + 10, Extender.Position.CLOSED, 64.5, 0.34, 0.9, Cluster.scoring),
